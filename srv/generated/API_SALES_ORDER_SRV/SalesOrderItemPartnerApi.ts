...
> implements EntityApi<SalesOrderItemPartner<DeSerializersT>, DeSerializersT> {
  ...
  private _schema?: {
    ...
    CONTACT_PERSON: OrderableEdmTypeField<
      ...
      true
    >;
    WORK_ASSIGNMENT_EXTERNAL_ID: OrderableEdmTypeField<
      SalesOrderItemPartner<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link workAssignmentExternalId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        WORK_ASSIGNMENT_EXTERNAL_ID: fieldBuilder.buildEdmTypeField(
