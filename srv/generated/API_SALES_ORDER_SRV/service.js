...
exports.apiSalesOrderSrv = apiSalesOrderSrv;
/*
...
function apiSalesOrderSrv(deSerializers = odata_v2_1.defaultDeSerializers) {
    return new ApiSalesOrderSrv((0, odata_v2_1.mergeDefaultDeSerializersWith)(deSerializers));
}
class ApiSalesOrderSrv {
    ...
    get operations() {
        return {
            rejectApprovalRequest: (parameter) => (0, operations_1.rejectApprovalRequest)(parameter, this.deSerializers),
            releaseApprovalRequest: (parameter) => (0, operations_1.releaseApprovalRequest)(parameter, this.deSerializers)
        };
    }
    get batch() {
