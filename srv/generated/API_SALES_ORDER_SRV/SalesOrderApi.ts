...
> implements EntityApi<SalesOrder<DeSerializersT>, DeSerializersT> {
  ...
  private _schema?: {
    ...
    SALES_ORDER_TYPE: OrderableEdmTypeField<
      ...
      true
    >;
    SALES_ORDER_TYPE_INTERNAL_CODE: OrderableEdmTypeField<
      SalesOrder<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link salesOrderTypeInternalCode} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SALES_ORDER_TYPE_INTERNAL_CODE: fieldBuilder.buildEdmTypeField(
